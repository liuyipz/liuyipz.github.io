...
<img class="img-rounded" src="/src/img/pg.png" alt="Thiago Rossener" width="400">
...
<img class="img-rounded" src="/src/img/pg1.png" alt="Thiago Rossener" width="400">
...
<img class="img-rounded" src="/src/img/pg2.png" alt="Thiago Rossener" width="400"><br>
...
<img class="img-rounded" src="/src/img/pg3.png" alt="Thiago Rossener" width="400">

8.配置Pgsql开启远程连接<br>
vim /var/lib/pgsql/9.6/data/pg_hba.conf<br>
<img class="img-rounded" src="/src/img/pg4.png" alt="Thiago Rossener" width="400"><br>
最后添加<br>
host	all		all	0.0.0.0/0	md5     #注意，host为小写，大写会导致服务启动失败。<br>
修改MedHot为trust，目的是在数据库自动备份任务时，本地登录时不需要输入密码。<br>
<img class="img-rounded" src="/src/img/pg5.png" alt="Thiago Rossener" width="400"><br>
9.配置完成后重启Pgsql服务<br>
systemctl restart postgresql-9.6<br>
10)查看Pgsql服务状态<br>
Systemctl status postgresql-9.6.service   #确认服务状态为running<br>
<img class="img-rounded" src="/src/img/pg6.png" alt="Thiago Rossener" width="400"><br>
至此数据库安装及配置完成！
